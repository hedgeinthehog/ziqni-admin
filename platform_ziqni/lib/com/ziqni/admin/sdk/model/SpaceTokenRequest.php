...
/**
 * SpaceTokenRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SpaceTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpaceTokenRequest';
    ...
    */
     ...
     * Sets user_token
     *
     * @param string|null $user_token The token recevied with key=\"user\" from the login response
     *
     * @return self
     */
     ...
     * Sets space_name
     *
     * @param string $space_name Name of the space user is trying to login to
     *
     * @return self
     */
