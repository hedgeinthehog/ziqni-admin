...
class Condition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'match_condition' => '\OpenAPI\Client\com\ziqni\admin\sdk\model\MatchCondition',
    ...
    {
        $this->setIfExists('match_condition', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\com\ziqni\admin\sdk\model\MatchCondition
     */
     ...
     *
     * @param \OpenAPI\Client\com\ziqni\admin\sdk\model\MatchCondition $match_condition match_condition
     *
     * @return self
     */
    public function setMatchCondition($match_condition)
    {
        if (is_null($match_condition)) {
            throw new \InvalidArgumentException('non-nullable match_condition cannot be null');
        }
     ...
     * Gets rules
     *
     * @return \OpenAPI\Client\com\ziqni\admin\sdk\model\Rule[]
     */
     ...
     * Sets rules
     *
     * @param \OpenAPI\Client\com\ziqni\admin\sdk\model\Rule[] $rules rules
     *
     * @return self
     */
