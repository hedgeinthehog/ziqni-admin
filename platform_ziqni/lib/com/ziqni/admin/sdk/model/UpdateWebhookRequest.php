...
class UpdateWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets post_to_url
     *
     * @param string|null $post_to_url A URL to post the webhook to
     *
     * @return self
     */
     ...
     * Sets triggers
     *
     * @param string[]|null $triggers A list of event triggers
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of a Webhook
     *
     * @return self
     */
