...
class Repository implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hosting_options'] === null) {
            $invalidProperties[] = "'hosting_options' can't be null";
        }
     ...
     * Sets name
     *
     * @param string $name The name of the repository. This cannot contain spaces or specil characters.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The description of the promotion page
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\com\ziqni\admin\sdk\model\HostingOptions
     */
     ...
     *
     * @param \OpenAPI\Client\com\ziqni\admin\sdk\model\HostingOptions $hosting_options hosting_options
     *
     * @return self
     */
