...
class CreateTagRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['entity_types'] === null) {
            $invalidProperties[] = "'entity_types' can't be null";
        }
     ...
     * Sets key
     *
     * @param string $key A unique key that represents a tag
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The description of the tag for your reference
     *
     * @return self
     */
     ...
     * Sets entity_types
     *
     * @param string[] $entity_types The model name the tag refers to
     *
     * @return self
     */
