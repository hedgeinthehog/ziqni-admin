...
class ChangePasswordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'two_factor_access_code' => 'twoFactorAccessCode'
    ];
    ...
    protected static $setters = [
        ...
        'two_factor_access_code' => 'setTwoFactorAccessCode'
    ];
    ...
    protected static $getters = [
        ...
        'two_factor_access_code' => 'getTwoFactorAccessCode'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('two_factor_access_code', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets email
     *
     * @param string $email The account username
     *
     * @return self
     */
    ...
    /**
     * Gets two_factor_access_code
     *
     * @return string|null
     */
    public function getTwoFactorAccessCode()
    {
        return $this->container['two_factor_access_code'];
    }

    /**
     * Sets two_factor_access_code
     *
     * @param string|null $two_factor_access_code Two factor access code if 2FA enabled
     *
     * @return self
     */
    public function setTwoFactorAccessCode($two_factor_access_code)
    {
        if (is_null($two_factor_access_code)) {
            throw new \InvalidArgumentException('non-nullable two_factor_access_code cannot be null');
        }
        $this->container['two_factor_access_code'] = $two_factor_access_code;
