...
/**
 * CreateContestForCompetitionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateContestForCompetitionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateContestForCompetitionRequest';
    ...
    protected static $attributeMap = [
        ...
        'group_stage_label' => 'groupStageLabel',
    ...
    protected static $setters = [
        ...
        'group_stage_label' => 'setGroupStageLabel',
    ...
    protected static $getters = [
        ...
        'group_stage_label' => 'getGroupStageLabel',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('group_stage_label', $data ?? [], null);
    ...
    */
     ...
     * Sets group_stage
     *
     * @param int|null $group_stage Is used for more complex Competitions e.g. multi round competitions where round 1 group stage matched round 2
     *
     * @return self
     */
    ...
    /**
     * Gets group_stage_label
     *
     * @return string|null
     */
    public function getGroupStageLabel()
    {
        return $this->container['group_stage_label'];
    }

    /**
     * Sets group_stage_label
     *
     * @param string|null $group_stage_label The name of the group stages
     *
     * @return self
     */
    public function setGroupStageLabel($group_stage_label)
    {
        if (is_null($group_stage_label)) {
            throw new \InvalidArgumentException('non-nullable group_stage_label cannot be null');
        }
        $this->container['group_stage_label'] = $group_stage_label;
