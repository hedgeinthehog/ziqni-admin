...
/**
 * EntrantCountResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EntrantCountResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EntrantCountResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('number_of_records', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['number_of_records'] === null) {
            $invalidProperties[] = "'number_of_records' can't be null";
        }
    ...
    public function setNumberOfRecords($number_of_records)
    {
        if (is_null($number_of_records)) {
            throw new \InvalidArgumentException('non-nullable number_of_records cannot be null');
        }
