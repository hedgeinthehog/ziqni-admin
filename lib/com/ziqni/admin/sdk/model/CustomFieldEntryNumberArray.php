...
/**
 * CustomFieldEntryNumberArray Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomFieldEntryNumberArray implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomFieldEntryNumberArray';
    ...
    */
     ...
     * Sets field_type
     *
     * @param string $field_type The data type stored in this generic object ( string, number, string[], number[])
     *
     * @return self
     */
