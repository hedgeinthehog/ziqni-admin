...
/**
 * UpdateActionTypeRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateActionTypeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateActionTypeRequest';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the Action Helper
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $add_constraints Additional constraints, if the value is present it means the
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $remove_constraints Additional constraints, if the value is present it means the
     *
     * @return self
     */
     ...
     *
     * @param string|null $unit_of_measure unit of measure id
     *
     * @return self
     */
