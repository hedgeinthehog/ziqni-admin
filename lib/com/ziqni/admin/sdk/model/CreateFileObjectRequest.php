...
/**
 * CreateFileObjectRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateFileObjectRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateFileObjectRequest';
    ...
    */
     ...
     * Sets mime_type
     *
     * @param string $mime_type Mime type of the file. Example mime types - text/csv or application/vmd.ms-excel or application/x-directory for directories
     *
     * @return self
     */
     ...
     *
     * @param string $parent_folder_path The folder containing the file within the repository
     *
     * @return self
     */
