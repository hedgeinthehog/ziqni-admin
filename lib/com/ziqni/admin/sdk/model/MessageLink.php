 ...
 */
class MessageLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessageLink';
    ...
    */
     ...
     * Sets entity_id
     *
     * @param string $entity_id The identifier of the entity
     *
     * @return self
     */
     ...
     * Sets entity_type
     *
     * @param string $entity_type The type of entity the link refers to like Award or Achievement, Contest, etc
     *
     * @return self
     */
     ...
     * Sets link_type
     *
     * @param string $link_type The type of link, relatesTo, refersTo, describes
     *
     * @return self
     */
