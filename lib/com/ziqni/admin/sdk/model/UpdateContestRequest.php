...
/**
 * UpdateContestRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateContestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateContestRequest';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name A name for the Contest. Can be translated
     *
     * @return self
     */
     ...
     * Gets round_type
     *
     * @return \OpenAPI\Client\com.ziqni.admin.sdk.model\RoundType|null
     */
     ...
     * Sets round_type
     *
     * @param \OpenAPI\Client\com.ziqni.admin.sdk.model\RoundType|null $round_type round_type
     *
     * @return self
     */
     ...
     *
     * @param int|null $min_number_of_entrants Minimum number of entrants for the contest
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $scheduled_start_date ISO8601 timestamp for when a Contest should start. All records are stored in UTC time zone
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $scheduled_end_date ISO8601 timestamp for when a Contest should end. All records are stored in UTC time zone
     *
     * @return self
     */
