...
/**
 * UpdateEntityRewardRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateEntityRewardRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateEntityRewardRequest';
    ...
    */
     ...
     * Gets entity_type
     *
     * @return \OpenAPI\Client\com.ziqni.admin.sdk.model\RewardEntityType|null
     */
     ...
     * Sets entity_type
     *
     * @param \OpenAPI\Client\com.ziqni.admin.sdk.model\RewardEntityType|null $entity_type entity_type
     *
     * @return self
     */
     ...
     * Sets entity_id
     *
     * @param string|null $entity_id A unique identifier of an achievement or contest. Dependant on entityType
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of a reward
     *
     * @return self
     */
     ...
     * Sets reward_rank
     *
     * @param string|null $reward_rank If used in the context of contest this will associate with the rank of the leaderboard
     *
     * @return self
     */
     ...
     * Sets reward_value
     *
     * @param float|null $reward_value Numerical value of the reward that will be issued based on the reward type
     *
     * @return self
     */
     ...
     * Sets reward_type_id
     *
     * @param string|null $reward_type_id A unique id of the Reward Type
     *
     * @return self
     */
